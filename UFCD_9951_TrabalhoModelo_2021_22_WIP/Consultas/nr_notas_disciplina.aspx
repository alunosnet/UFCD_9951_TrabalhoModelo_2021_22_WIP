<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nr_notas_disciplina.aspx.cs" Inherits="UFCD_9951_TrabalhoModelo_2021_22_WIP.Consultas.nr_notas_disciplina" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <!--Menu-->
            <h2>Nº de notas por disciplina</h2>
            <asp:GridView CssClass="table" ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                <Columns>
                    ...
                    <asp:BoundField DataField="Expr1" HeaderText="Nº" ReadOnly="True" SortExpression="Expr1"></asp:BoundField>
                </Columns>
            </asp:GridView>
            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' 
                SelectCommand="SELECT disciplinas.nome, COUNT(*) AS Expr1 FROM disciplinas INNER JOIN notas ON disciplinas.codigo = notas.codigo_disciplina GROUP BY notas.codigo_disciplina, disciplinas.nome"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
